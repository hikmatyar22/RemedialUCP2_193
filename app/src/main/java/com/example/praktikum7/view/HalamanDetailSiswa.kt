...
import com.example.praktikum7.viewmodel.DetailBukuUiState
...
import com.example.praktikum7.viewmodel.toBuku
...
fun DetailDataBuku(
    ...
    Card(
        ...
        Column(
            ...
            BarisDetailData(
                label = "Stok",
                itemDetail = buku.stok.toString() ?: "0",
                modifier = Modifier.padding(
                    horizontal = dimensionResource(id = R.dimen.padding_medium)
                )
            )
